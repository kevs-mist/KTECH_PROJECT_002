        ...
        <div className="min-h-screen p-8 font-sans page-enter" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)' }}>
            ...
            <main className="max-w-7xl mx-auto space-y-8 sm:space-y-10">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-0" style={{ border: '1px solid var(--border)', borderRadius: '8px', overflow: 'hidden' }}>
                    ...
                    <div className="p-4 sm:p-6" style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border-subtle)' }}>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 md:p-8 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-slate-200 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
                                ...
                                {selectedTicket.status !== 're_raised' && selectedTicket.status !== 'closed' && (
                                    <div className="mt-4 animate-in fade-in duration-300">
                                        ...
                                        <textarea
                                            className={`w-full border rounded-2xl p-4 text-sm outline-none transition-all resize-none shadow-inner ${actionError?.includes("Reason") ? 'ring-2 ring-red-500/20' : ''}`}
                                            style={{
